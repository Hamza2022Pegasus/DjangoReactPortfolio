...
class AboutMeSeciton(models.Model):
    ...
    descriprion = models.CharField(verbose_name="Description",max_length=200,blank=True,null=True)
    image = models.CharField(max_length=100, blank=True, null=True,verbose_name="Google Drive Image Id")
    linkToCV = models.CharField(
        verbose_name="URL link for CV",
        blank=True,
        null=True,
...
class SMLinks(models.Model):
    ...
    icon = models.CharField(max_length=50,null=True,blank=True,verbose_name="Icon eg: bx-linkedin")
