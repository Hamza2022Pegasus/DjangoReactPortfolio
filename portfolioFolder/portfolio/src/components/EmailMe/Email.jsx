...
const Email = (e) => {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    const body = {
      ClientName : e.target.user_name.value,
      Recipient : e.target.user_email.value,
      Message : e.target.message.value
      }
    const csrfHeader = {headers: {'X-CSRFToken': csrftoken}}
    axios.post("http://127.0.0.1:8000/api/send_email",body,csrfHeader)
  ...
  return (
    <>
      <section id="contact" className="reachme-container">
                    ...
                    <div className="contact-info  " key={details.id}>
                      <div className="contact-details">
                        ...
                        <div className="contact-mi">
                          ...
                          <p className="d-name">{details.info}</p>
                        </div>
                      </div>
                    </div>
                  ))}
