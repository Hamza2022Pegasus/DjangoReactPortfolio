...
const AboutMe = () => {
  ...
  const cv = contacts1Details && contacts1Details.map((data1) => data1.linkToCV);
  // console.log(cv);
  // console.log(conta2);
  ...
  return (
    <>
      {aboutMe &&
        aboutMe.map((details) => (
          <section id="about" key={details.id}>
            <div className="aboutMe-container">
              ...
              <div className="abouMe-row">
                ...
                >
                  <img src={`${img_300}${details.image}`} alt="" />
                </div>
                <div
